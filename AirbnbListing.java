...
public class AirbnbListing {
    ...
    public String fullDesription() {
        String detials = name.substring(0, 1).toUpperCase() + name.substring(1);
        return   detials +"\n\n"+
        
                "Property ID:  " + id + "\n"+
                "Host ID:  " + host_id +"\n"+
                "Host name:  " + host_name +"\n"+
                "No. of listings managed by host:  " + calculatedHostListingsCount +"\n\n"+
                ...
                "Minimum nights stay:  " + minimumNights +"\n\n"+
                
                "Last Review:  " + lastReview +"\n"+
                "Total number of reviews:  " + numberOfReviews +"\n"+
                "Revies per month:  " + reviewsPerMonth +"\n"+
                "Days available in a year:  " + availability365;
    ...
    public String toString() { 
        String currentHostName= getHost_name();
        int currentPrice = getPrice();
        int currentNoReviews = getNumberOfReviews();
        int currentMinNights = getMinimumNights();
        String details = "Host's Name:      " +currentHostName+ 
                   "\n" +"Price:                   "+currentPrice+ 
                   "\n" +"Total Reviews:    " +currentNoReviews+ 
                   "\n" +"Minimun Stay:     "+currentMinNights;
